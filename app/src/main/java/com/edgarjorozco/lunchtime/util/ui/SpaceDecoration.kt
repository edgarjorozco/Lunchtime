...
class SpaceDecoration(private val verticalSpaceHeight: Int, private val spaceOnFirstItem: Boolean = true, private val spaceOnLastItem: Boolean = true) : RecyclerView.ItemDecoration() {
