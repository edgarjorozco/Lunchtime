...
object PlaceTypes {
    ...
    const val LIGHT_RAIL_STATION = "light_rail_station"
    ...
    const val TOURIST_ATTRACTION = "tourist_attraction"
    ...
    /**
     * Google Places API also returns these three types for all places of type restaurant
     */
